...
WHERE 
    U.USERNAME='hgranger'
    AND U.USERPASSWORD =111111
ORDER BY A.ACCOUNT_ID;

SELECT U.USER_ID, A.ACCOUNTS_TYPE
FROM ACCOUNTS A INNER JOIN BANK_USER U ON A.USER_ID = U.USER_ID
WHERE A.ACCOUNT_ID = 1;


SELECT ACCOUNT_ID, ACCOUNTS_TYPE, ACCOUNT_BALANCE, USER_ID FROM ACCOUNTS;

SELECT U.USER_ID, A.ACCOUNT_ID, A.ACCOUNTS_TYPE, A.ACCOUNT_BALANCE
FROM ACCOUNTS A INNER JOIN BANK_USER U ON A.USER_ID = U.USER_ID
WHERE A.ACCOUNT_ID = 1;