...
INSERT ALL
    INTO ACCOUNTS (USER_ID, ACCOUNTS_TYPE, ACCOUNT_BALANCE) VALUES (65,'SAVINGS', 30.00)
    INTO ACCOUNTS (USER_ID, ACCOUNTS_TYPE, ACCOUNT_BALANCE) VALUES (65,'CHECKING', 39.00)
    INTO ACCOUNTS (USER_ID, ACCOUNTS_TYPE, ACCOUNT_BALANCE) VALUES (67,'CHECKING', 20.00)
    INTO ACCOUNTS (USER_ID, ACCOUNTS_TYPE, ACCOUNT_BALANCE) VALUES (66,'SAVINGS', 10.00)
SELECT * FROM DUAL;
...
INSERT INTO ACCOUNTS (USER_ID) VALUES (69);
INSERT INTO TRANSACTION_HISTORY (ACCOUNT_ID, DEPOSIT) VALUES (66, 30);




CREATE OR REPLACE PROCEDURE WITHDRAW_SP
(ACCOUNTID IN NUMBER, WITHDRAW IN NUMBER)
IS
...
BEGIN
  ...
  IF CURRENT_BALANCE > 0 THEN
     ...
     INSERT INTO TRANSACTION_HISTORY (DEPOSIT)
     VALUES (DEPOSIT);
  END IF; 
END;
/
...
DELETE FROM BANK_USER WHERE USER_ID = 22;
DELETE FROM BANK_USER WHERE USER_ID = 23;
DELETE FROM BANK_USER WHERE USER_ID = 24;
